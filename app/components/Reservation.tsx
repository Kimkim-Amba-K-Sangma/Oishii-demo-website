      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
        ...
        >
          <div className="space-y-4 sm:space-y-6">
            <h3 className="font-serif text-2xl sm:text-3xl md:text-4xl text-[#1F1F1F]">
          ...
          <div className="mt-6 sm:mt-10">
            <button
              type="submit"
              className="w-full bg-[#D8C2A1] text-white py-3 sm:py-4 rounded-full tracking-widest text-xs sm:text-sm uppercase hover:shadow-[0_0_30px_rgba(216,194,161,0.8)] transition"
            >
              Confirm Reservation
            </button>
